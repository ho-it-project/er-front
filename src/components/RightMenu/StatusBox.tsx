...
export default function StatusBox() {
  ...
  console.log(emergencyCenterInfo);
  ...
  return (
    <div className="mb-[2rem] h-[21rem] w-[38rem] rounded-2xl bg-white px-[2rem] py-[3rem]">
      <div className="flex flex-wrap justify-around gap-[2rem]">
        {bedSummarys &&
          bedSummarys.map((summary, index) => (
            <div
              className="flex flex-col items-center justify-center text-medium font-medium-L"
              key={index}
            >
