export default function EmployeeListHeader() {
  return (
    <div className="sticky top-[10rem] z-[1] flex h-[7.2rem] w-full items-center justify-between rounded-3xl border-2 border-main bg-bg px-[4rem] text-[1.8rem] font-[700] text-main">
